...
import { getSeats, loadSeatsRequest, getRequests, loadSeats, endRequest } from '../../../redux/seatsRedux';
...
const SeatChooser = ({ chosenDay, chosenSeat, updateSeat }) => {
  ...
  const availableSeats = () => 50 - seats.filter(seat => seat.day === chosenDay).length;
  ...
  return (
    <div>
      ...
      <><div className="seats">{[...Array(50)].map((x, i) => prepareSeat(i+1) )}</div><p className='summary'>Free setas: {availableSeats()}/50</p></>}
